...
contract ExoToken is ERC20, BasicToken {
  ...
  function ExoToken(uint256 initialSupply) public {
 ...
 function doMint(address buyerAddress, uint256 amount)  whenNotPaused() returns (bool) { //private;  bug: Incorrect Function Visibility
