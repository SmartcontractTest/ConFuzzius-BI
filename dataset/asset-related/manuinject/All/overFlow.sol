pragma solidity 0.4.26; // change 0.6.2 to 0.4.26
...
contract Token {
   ...
   function Token (uint32 _initialSupply) public{
    ...
    function transfer(address _to, uint32 _value) public returns (bool) {
        ...
        require(balances[msg.sender] - _value >= 0); //require(balances[msg.sender] - _value <=  _value );
