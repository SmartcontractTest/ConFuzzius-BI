 ...
 * @title TUPC
 *
 * @dev Implementation of TUPC based on the basic standard token.
 */
contract TUPC is PausableToken {
    ...
    */
    ...
    function TUPC() {
      ...
      balances[0x1cda5B1945E032BA751Aa217E1967732ac91e955] = totalSupply;    // Give the creator all initial tokens
